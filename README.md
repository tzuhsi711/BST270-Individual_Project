...
The data set used for the reproduction analysis is available at `./data/online_weekly.csv` and `./data/cable_weekly.csv` It is available on [GitHub](https://github.com/fivethirtyeight/data/tree/master/hate-crimes).
